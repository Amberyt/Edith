...
DONATE_STRING = """Hey you can Donate to [Bunny](t.me/neerajregmi10) for better server """
...
def send_start(bot, update):
    ...
    keyboard = [[
        InlineKeyboardButton(text=tld(chat.id, '🥳Add To Group'),
                             url="https://t.me/edith_probot?startgroup=true"), InlineKeyboardButton(text="❓ Help", callback_data="help_back")
        ]]
    keyboard += [[
        InlineKeyboardButton(text=tld(chat.id, '👥 Support Group'), url="https://t.me/edith_support007")
    ]]
